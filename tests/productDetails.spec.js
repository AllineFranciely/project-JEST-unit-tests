...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    expect(productDetails('Alchool', 'Mascara')[1].details.productId.endsWith('123')).toBe(true);
  });
});

// Neste requisito o site a seguir foi pesquisado para entendimento do comando endsWith: https://developer.mozilla.org/pt-BR/docs/Web/JavaScript/Reference/Global_Objects/String/endsWith
